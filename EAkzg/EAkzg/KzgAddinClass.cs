...
namespace EAkzg
{
    public class KzgAddinClassv2
    {
        ...
        const string menuWymagania = "Zarządzanie wymaganiami";
        ...
        public object EA_GetMenuItems(EA.Repository Repository, string Location, string MenuName)
        {
            ...
            switch (MenuName)
            {
                ...
                case menuEdytuj:
                    ...
                    return subMenus1;
                case menuWstepne:
                    string[] subMenus2 = {/* menuWstepneEAP, menuSeparator,*/menuWymagania, menuEdytujWkladyIT, menuEdytujWkladyNT,/* menuSeparator, menuWstepneOdswiezStatusyWymagan,*/ menuSeparator, menuWstepneDetale };
                    return subMenus2;
                case menuNT:
