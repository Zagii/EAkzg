...
namespace EAkzg
{
    ...
    public class FtpClient
    {
        ...
        public void ChangeDirectory(string directory)
        {
            ...
            stat.Loguj("ChangeDirectory(" + directory + ");");
        }
        ...
        public bool DirectoryExists(string directory)
        {
            try
            {
                ...
                stat.Loguj("DirectoryExists(" + directory + "); istnieje "); 
                return true;
            }
            catch { }
            stat.Loguj("DirectoryExists(" + directory + "); nie istnieje "); 
            return false;
        }
        ...
        public void CreateDirectory(string directory)
        {
            try
            {
                ...
                stat.Loguj("CreateDirectory(" + directory + "); utworzono"); 
            }
            catch(Exception e)
            {
                stat.Loguj("CreateDirectory(" + directory + "); wyjątek: "+e.Message); 
            }
        ...
        public void UploadFiles(params string[] paths)
        {
            try
            {
                ...
                stat.Loguj("UploadFiles(" + paths[0] + "); pobrano");
            }
            catch (Exception e)
            {
                String tmp = "UploadFiles(" + paths[0] + "); " + e.Message;
                stat.Loguj(tmp);
            }
        }
        ...
        public void DownloadFiles(string path, params string[] files)
        {
            try
            {
                ...
                stat.Loguj("DownloadFiles(" + path + ", " + files[0] + "); pobrano");
            }
            catch (Exception e)
            {
                String tmp = "DownloadFiles(" + path + ", " + files[0] + "); " + e.Message;
                stat.Loguj(tmp);
            }
        }
