...
namespace EAkzg
{
    class Crozdz1 : CrozdzialUtils
    {
        string[,] spis =new string[,] {{"1 ORGANIZACYJNE","r1abc","spis1"},//0
                             {"1.1 Zawartość, cel i przeznaczenie dokumentu","r1a1","spis1-1"},//1
                             {"1.2 Słownik użytych skrótów i pojęć","r1a2","spis1-1"},//2
                             {"1.3 Załączniki, powiązane dokumenty","r1a3","spis1-1"},//3
                             {"1.4 Zespół projektowy","r1a4","spis1-1"},
                             {"1.5 Powiązania z innymi projektami","r1a5","spis1-1"}
        };//4
        string[,] spisEN = new string[,] {{"1 INTRODUCTION","r1abc","spis1"},//0
                             {"1.1 Terms of reference","r1a1","spis1-1"},//1
                             {"1.2 Dictionary","r1a2","spis1-1"},//2
                             {"1.3 Includes","r1a3","spis1-1"},//3
                             {"1.4 Project team","r1a4","spis1-1"},
                             {"1.5 Relation with other projects","r1a5","spis1-1"}
        };//4
        ...
        Statystyki okno;
        bool jezykPolski;
        public Crozdz1(CModel modelProj, /*EA.Package p,*/ String sciezkaZrodlo, String sciezkaDocelowa, Word W, Statystyki o, bool jezykPl)
        ...
        private String dajStatycznyTekst(ref int nrRozdz)
        {
          ...
          //  word.ustawKoniec("Rozdzial1a");
         //   word.wstawZnacznik("Rozdzial1a", "");
    ...
    private string dajZaleznosci(/* nowy generator Package d,*/ ref int wiersz)
    {
        ...
        int nrRozdz = 0;
          ...
          //  word.wstawZnacznik("Rozdzial1", "");
             ...
             * Package sl = null ;
              Package zal = null; ;
              Package papiery = null; ;
             foreach(Package pak in definicjePckg.Packages)
              {
                  switch (pak.Name)
                  {
                      case "Słownik":
            ...
            w += "</div>";
    //        word.usunKoniecRozdzialu("Rozdzial1");
    //        word.usunKoniecRozdzialu("Rozdzial1a");
      //      word.usunKoniecRozdzialu("Rozdzial1b");
            return w;
        }
