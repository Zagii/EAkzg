...
namespace EAkzg
{
        class Crozdz2 : CrozdzialUtils
        {
            ...
            bool jezykPolski;
            public Crozdz2(EA.Repository r, EA.Package p, Package wymPckg,Package konPckg, String sciezkaZrodlo,String sciezkaDocelowa,Word W,Statystyki o,bool jezykPl)
            ...
            public Crozdz2(CModel modelProj, String sciezkaZrodlo, String sciezkaDocelowa, Word W, Statystyki o, bool jezykPl)
                : base(sciezkaZrodlo, sciezkaDocelowa)
            {
                jezykPolski = jezykPl;
                word = W;
            ...
            private string dajOgraniczeniaRozwiazania(ref int nrRozdz)
            {
             ...
             /* 
              * nowy generator
                EA.Package ograniczeniaPckg=EAUtils.dajPakietSciezkiP(ref projekt, "Definicje", "Ograniczenia rozwiązania");
                
                if (ograniczeniaPckg.Elements.Count > 0)
                */
            ...
            private string dajWymaganiaPakietu(Package d, ref int i,ref int ii,ref  Wordy.Table tab,String pakTxt,string[] typyWymagan)
            {
              //  return ""; /////////////////////////<<<<<<<<<<-------------------------- zeby szybciej sie generowalo
                ...
                foreach (Element e in d.Elements)
                {
                    ...
                    Element ee = e;
                    bool czyRobic = /*false;*/ modelProjektu.dodajWymaganieDoListy(ref ee);
                  /*nowy generator
            ...
            private void wypiszWymagania(ref int wiersz)
            {
             ...
             //   int ii = 1;
                ...
                {
                    word.wstawWierszDoTabeli("Rozdzial1b", tab, i ++, new string[] { e.Stereotype,/* pakTxt,*/ e.Name, e.Status });
                }
       ...
       //       dajWymaganiaPakietuArch(d, ref i, ref ii, "", new string[] { "Arch." });
           ...
           //    dajWymaganiaPakietu(modelProjektu.WymaganiaPckg, ref i, ref ii, ref tab, "", CmodelKonfigurator.stereotypyWymaganBiznesowych);
            ...
            public String dajRozdzial()
            {
               ...
               // word.wstawZnacznik("Rozdzial2", "");
            //    word.dajKoniecDoc();
                w += dajTytulRozdz("1", ref nrRozdz);
               /* nowy generator
                w += dajKoncepcje(koncepcjaITPckg,ref nrRozdz,false);
                w += dajKoncepcje(koncepcjaNTPckg, ref nrRozdz,true);
                * */
                dajKoncepcje(CModel.IT, ref nrRozdz, false);
                dajKoncepcje(CModel.NT, ref nrRozdz, true);
                 w += dajOgraniczeniaRozwiazania(ref nrRozdz);
      
                 wypiszWymagania(ref nrRozdz);
                 wypiszWymaganiaArch(ref nrRozdz);
                //w += dajWymagania(/* nowy generator wymaganiaPckg,*/ ref nrRozdz);
                //w += dajWymaganiaArch(wymaganiaPckg, ref nrRozdz);
